...
# our pipeline (uses per-eye 80:20 builder)
from iris.pipeline import (
    build_iris_codes_dataset_per_eye,
    run_full_pipeline,
...
def main():
    # Optionally build DBs once:
    # build_iris_codes_dataset_per_eye(
    #     dataset_dir="CASIA-Iris-Thousand",
    #     train_codes_path="iris_codes/iris_codes_train.json",
    #     test_codes_path="iris_codes/iris_codes_test.json",
    #     subjects_limit=100,
    #     gallery_k_per_eye=8,
    #     radial_res=64,
    #     angular_res=360
